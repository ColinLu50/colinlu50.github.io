(function () {
  ...
  // Prepare all enhancements used on this page after its first paint, without
  // waiting for a scroll/click or the load event (which includes slow images).
  var started = false;
  var frame = 0;
  var timer = window.setTimeout(start, 1000);
  function start() {
    if (started) return;
    started = true;
